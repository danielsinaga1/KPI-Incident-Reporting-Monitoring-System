        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.departmentAddressTo.title_singular') }}
                </div>
                <div class="panel-body">

                    <form action="{{ route("admin.department-address-tos.store") }}" method="POST" enctype="multipart/form-data">
                        @csrf
