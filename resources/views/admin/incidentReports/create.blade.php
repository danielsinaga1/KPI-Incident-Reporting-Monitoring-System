                ...
                <div class="panel-body">
                    ...
                    <form action="{{ route("admin.incident-reports.store") }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('location') ? 'has-error' : '' }}">
                            <label for="location">{{ trans('cruds.incidentReport.fields.location') }}*</label>
                            ...
                            <p class="helper-block">
                                {{ trans('cruds.incidentReport.fields.location_helper') }}
                            </p>
                        </div>
                        <div class="form-group {{ $errors->has('date_incident') ? 'has-error' : '' }}">
                            ...
                            @endif
                            <p class="helper-block">
                                {{ trans('cruds.incidentReport.fields.date_incident_helper') }}
                            </p>
                        </div>
                        <div class="form-group {{ $errors->has('root_cause_id') ? 'has-error' : '' }}">
                            <label for="root_cause">{{ trans('cruds.incidentReport.fields.root_cause') }}*</label>
                        ...
                        <div class="form-group {{ $errors->has('perbaikan') ? 'has-error' : '' }}">
                            ...
                            @endif
                            <p class="helper-block">
                                {{ trans('cruds.incidentReport.fields.perbaikan_helper') }}
                            </p>
                        </div>
