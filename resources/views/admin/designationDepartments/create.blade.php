        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.dept_designation.title_singular') }}
                </div>
                <div class="panel-body">

                    <form action="{{ route("admin.designation-departments.store") }}" method="POST" enctype="multipart/form-data">
                        @csrf
